    ...
    <section class="bg-light min-h-screen flex items-center justify-center">
      ...
      <div class="bg-gray-100 flex rounded-lg shadow-lg max-w-3xl items-center">
        ...
        <div class="md:w-1/2 px-8 md:px-16 py-5" >
          ...
          <form method="POST" action="login/process" method="POST" class="flex flex-col mt-3">
            @csrf
            {{-- USERNAME --}}
            <label class="mt-3 block text-xs font-semibold">Username</label>
            <input class="mt-2 p-2 rounded-xl border border-gray-300 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" id="email" type="text" name="email" placeholder="Enter your username">
            {{-- PASSWORD --}}
            <label class="mt-3 block text-xs font-semibold">Password</label>
            <div class="relative mt-2">
              <input class="p-2 rounded-xl border w-full border-gray-300 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" id ="password" type="password" name="password" placeholder="*****">
            </div>
            {{-- FORGOT PASSWORD --}}
            ...
            {{-- LOGIN BTN --}}
            <button type="submit" class="bg-primary mt-5 rounded-xl text-white py-2 hover:scale-105 duration-300">Sign in</button>
          </form>
