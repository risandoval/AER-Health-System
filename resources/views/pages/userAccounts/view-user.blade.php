<x-layout class="bg-light">
    <section class="flex justify-center w-full pt-navbar pb-10">
        <div  class="flex flex-col bg-white min-w-[400px] md:w-[570px] min-h-[600px] rounded-xl drop-shadow-lg mt-12 mx-4">
            <div class="px-6 py-4">
                <h2 id="userTitle" class="text-xl"><strong>User Information</strong></h2>
                @if(session('error'))
            ...
            <form action="/users/update/{{$viewUser->id}}" method="POST" id="userForm">
                @csrf
                @method('PUT')      
                <div class="flex flex-wrap border-y gap-5 px-6 py-8">    
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="first_name" value="{{$viewUser->first_name}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="middle_name" value="{{$viewUser->middle_name}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="last_name" value="{{$viewUser->last_name}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="date" name="birthday" value="{{$viewUser->birthday}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="contact" value="{{$viewUser->contact}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="email" value="{{$viewUser->email}}" disabled class="form-input md:col-start-4 md:col-span-10 focus:ring-0 text-disabled-text bg-disabled-bg disabled:mb-0">
                ...
                <div class="flex gap-3 justify-end p-3">
                    <button id="closeButton" type="button" class="close-btn bg-gray-200 text-black text-sm rounded-full px-4 py-2 hover:bg-black hover:text-white">Close</button>
                    <button id="editButton"class="text-white bg-primary px-4 py-2 rounded-full hover:bg-white hover:text-primary hover:ring-primary hover:ring-1 duration-100">Edit</button>
                </div>
            </form>
        </div>
    </section>
