            ...
            <form action="{{route('update',['id'=>$viewUser->id])}}" method="POST" id="userForm">
                ...
                <div class="flex flex-wrap border-y gap-5 px-6 py-8">    
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="middle_name" value="{{$viewUser->middle_name}}" disabled {{$errors->any() ? '' : 'disabled'}} class="form-input md:col-start-4 md:col-span-10 focus:ring-0:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="last_name" value="{{$viewUser->last_name}}" disabled {{$errors->any() ? '' : 'disabled'}} class="form-input md:col-start-4 md:col-span-10 focus:ring-0:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="date" name="birthday" value="{{$viewUser->birthday}}" disabled {{$errors->any() ? '' : 'disabled'}} class="form-input md:col-start-4 md:col-span-10 focus:ring-0:mb-0">
                    ...
                    <div class="flex-wrap items-center md:grid md:grid-cols-12 w-full">
                        ...
                        <input type="text" name="contact" value="{{$viewUser->contact}}" disabled {{$errors->any() ? '' : 'disabled'}} class="form-input md:col-start-4 md:col-span-10 focus:ring-0:mb-0">
