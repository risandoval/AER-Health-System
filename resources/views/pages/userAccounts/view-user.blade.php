        ...
        <div  class="bg-white rounded-xl max-w-[800px] min-h-[600px] drop-shadow-lg mt-12 mx-4">
            ...
            <form action="/user/view/{{$viewUser->id}}" method="POST">
                ...
                <div class="lg:grid lg:grid-cols-4 border-y p-10 gap-6 items-center">    
                    ...
                    <input type="text" name="first_name" value="{{$viewUser->first_name}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                    ...
                    <input type="text" name="middle_name" value="{{$viewUser->middle_name}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                    ...
                    <input type="text" name="last_name" value="{{$viewUser->last_name}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                    ...
                    <input type="text" name="username" value="{{$viewUser->username}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="password" name="password" value="{{$viewUser->password}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <select name="role" value="{{$viewUser->role}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                    ...
                    <select name="position" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                        <option value="" selected hidden>select..</option>
                        <option value="Admin" {{$viewUser->role == 'Admin' ? 'selected' : ''}}>Admin</option>
                    ...
                    <input type="date" value="{{$viewUser->birthday}}" name="birthday" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" max="9999-12-31" disabled>
                    ...
                    <input type="text" value="{{$viewUser->contact}}" name="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
                    ...
                    <input type="text" value="{{$viewUser->email}}" name="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" disabled>
