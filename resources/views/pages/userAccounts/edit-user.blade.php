<x-layout>
    <section class="flex flex-col gap-12 bg-light w-full min-h-screen items-center justify-center pt-navbar pb-10">
        <div  class="bg-white rounded-xl max-w-[800px] min-h-[600px] drop-shadow-lg mt-12 mx-4">
            ...
            <form action="{{url("users/update/$editUser->id")}}" method="POST">
                @csrf
                @method('PUT')             
                <div class="lg:grid lg:grid-cols-4 border-y p-10 gap-6 items-center">    
                    ...
                    <input type="text" name="middle_name" value="{{$editUser->middle_name}}" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="text" name="last_name" value="{{$editUser->last_name}}" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="text" name="username" value="{{$editUser->username}}" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="password" name="password" value="{{$editUser->password}}" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="password" name="confirm_password" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <select name="specialization" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                        ...
                        <option value="Barangay Health Worker" {{$editUser->specialization == 'Barangay Health Worker' ? 'selected' : ''}}>Barangay Health Workers (BHW)</option>
                    </select>
                    ...
                    <input type="date" value="{{$editUser->birthday}}" name="birthday" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" max="9999-12-31">
                    ...
                    <input type="text" value="{{$editUser->contact}}" name="contact" class="rounded-xl border w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="text" value="{{$editUser->email}}" name="email" class="rounded-xl border outline-[0.5px] w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
