        ...
        <div  class="bg-white rounded-xl min-h-[600px] drop-shadow-lg mt-12 mx-4">
            ...
            <form action="/users/add" method="POST">
                <div class="lg:grid lg:grid-cols-4 border-y p-10 gap-6 items-center">    
                    ...
                    <input type="date" name="birthdate" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" max="9999-12-31" >
                    ...
                    <input type="text" name="contact" id="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="Enter 11 digit number">
                    ...
                    <input type="text" name="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                ...
                <div class="flex gap-3 justify-end p-3">
                    ...
                    <button type="submit" class="bg-primary text-white text-sm rounded-full px-5 py-2 font-bold">Add User</button>
                </div>
            </form>
        </div>
    </section>
