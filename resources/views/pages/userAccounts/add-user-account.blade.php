<x-layout>
    <section class="flex flex-col gap-12 bg-light w-full min-h-screen items-center justify-center pt-navbar pb-10">
        <div  class="bg-white rounded-xl max-w-[800px] min-h-[600px] drop-shadow-lg mt-12">
            <div class="px-6 py-4">
            ...
            <form action="/users/add" method="POST">
                <div class="grid grid-cols-4 border-y p-10 gap-6 items-center">    
                    ...
                    <input type="text" name="last_name" id="last_name"class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
                    ...
                    <select name="role" id="role" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
                    ...
                    <select name="specialization" id="specialization" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
                        <option value="" selected hidden>select..</option>
                        <option value="Admin">Admin</option>
                        <option value="Doctor">Doctor</option>
                        <option value="BHW">Barangay Health Workers (BHW)</option>
                    ...
                    <input type="date" name="birthdate" id="birthdate" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6" max="9999-12-31" >
                    ...
                    <input type="number" name="contact" id="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6" placeholder="Enter 11 digit number">
                    ...
                    <input type="text" name="email" id="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6" >
                    ...
                    <input type="text" name="username" id="username" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
                    ...
                    <input type="password" name="password" id="password" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 -mb-6">
