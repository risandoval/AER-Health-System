        ...
        <div  class="bg-white rounded-xl max-w-[800px] min-h-[600px] drop-shadow-lg mt-12 mx-4">
            ...
            <form action="/users/add" method="POST">
                <div class="lg:grid lg:grid-cols-4 border-y p-10 gap-6 items-center">    
                    ...
                    <input type="text" name="first_name" id="first_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    <p class="col-start-2 col-span-3 text-sm text-red mb-2 lg:-mb-2"> @error ('first_name'){{$message}} @enderror </p>                    

                    <label for="middle_name" class="col-span-1 whitespace-nowrap -mb-6">Middle Name:</label>
                    <input type="text" name="middle_name" id="middle_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="text" name="last_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <select name="specialization" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                        <option value="" selected hidden>select..</option>
                        <option value="Admin">Admin</option>
                        <option value="Doctor">Doctor</option>
                        <option value="BHW">Barangay Health Workers (BHW)</option>
                    </select>
                    <p class="col-start-2 col-span-3 text-sm text-red mb-2 lg:-mb-2"> @error ('specialization'){{$message}} @enderror </p> 

                    <label for="birthdate" class="col-span-1 whitespace-nowrap -mb-6">Birthdate:</label>
                    <input type="date" name="birthdate" id="birthdate" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" max="9999-12-31" >
                    <p class="col-start-2 col-span-3 text-sm text-red mb-2 lg:-mb-2"> @error ('birthdate'){{$message}} @enderror </p> 

                    <label for="contact" class="col-span-1 whitespace-nowrap -mb-6">Mobile No:</label>
                    <input type="number" name="contact" id="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="Enter 11 digit number">
                    ...
                    <input type="text" name="email" id="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="password" name="password" id="password" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                ...
                <div class="flex gap-2 justify-end p-3">
                    ...
                    <button type="submit" class="bg-secondary text-white text-sm rounded-full px-5 py-2 font-bold hover:bg-white hover:text-secondary hover:ring-secondary hover:ring-1">Add User</button>
                </div>
            </form>
        </div>
    </section>
