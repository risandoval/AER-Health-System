        ...
        <div  class="bg-white rounded-xl max-w-[800px] min-h-[600px] drop-shadow-lg mt-12 mx-4">
            ...
            <form action="/store" method="POST">
                ...
                <div class="lg:grid lg:grid-cols-4 border-y p-10 gap-6 items-center">    
                    <label for="first_name" class="col-span-1 whitespace-nowrap -mb-6">First Name: <span class="text-red">*</span></label>
                    <input type="text" name="first_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="ex. Juan">
                    ...
                    <input type="text" name="middle_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="ex. Malakas">
                    <p class="col-start-2 col-span-3 text-sm text-red mb-2 lg:-mb-2"> @error ('middle_name'){{$message}} @enderror </p>
                    
                    <label for="last_name" class="col-span-1 whitespace-nowrap -mb-6">Last Name: <span class="text-red">*</span></label>
                    <input type="text" name="last_name" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="ex. de la Cruz">
                    ...
                    <input type="text" name="username" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <input type="password" name="password" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <label for="role" class="col-span-1 whitespace-nowrap -mb-6">Role: <span class="text-red">*</span></label>
                    <select name="role" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6">
                    ...
                    <label for="position" class="col-span-1 whitespace-nowrap -mb-6">Position: <span class="text-red">*</span></label>
                    ...
                    <label for="birthday" class="col-span-1 whitespace-nowrap -mb-6">Birthday: <span class="text-red">*</span></label>
                    <input type="date" name="birthday" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" max="9999-12-31">
                    <p class="col-start-2 col-span-3 text-sm text-red mb-2 lg:-mb-2"> @error ('birthday'){{$message}} @enderror </p>

                    <label for="contact" class="col-span-1 whitespace-nowrap -mb-6">Mobile No: <span class="text-red">*</span></label>
                    <input type="text" name="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="ex. 09123456789">
                    ...
                    <input type="text" name="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3 mb-2 lg:-mb-6" placeholder="ex. juandelacruz@example.com">
