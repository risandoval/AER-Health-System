...
@endif
            ...
            <form action="/user/{{$editUser->id}}" method="POST" class="flex flex-col">
                @csrf
                @method('PUT')             
            <div class="grid grid-cols-4 border-y p-10 gap-6 items-center">    
                ...
                <input type="text" name="first_name" value="{{$editUser->first_name}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <input type="text" name="last_name" value="{{$editUser->last_name}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <input type="text" name="username" value="{{$editUser->username}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <input type="password" name="password" value="{{$editUser->password}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <input type="text" name="role" value="{{$editUser->role}}" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <select name="position" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                    <option value="{{$editUser->position}}">{{$editUser->position}}</option>
                ...
                <input type="date" value="{{$editUser->birthday}}" name="birthday" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3" max="9999-12-31">
                ...
                <input type="text" value="{{$editUser->contact}}" name="contact" class="rounded-xl border outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
                ...
                <input type="text" value="{{$editUser->email}}" name="email" class="rounded-xl border outline-[0.5px] outline-secondary w-full focus:ring-0 border-gray-300 col-span-3">
